  ...
  "en-US": {
    translation: {
      ...
      "profile": {
        ...
        "paymentDescYec": "To enable payment monitoring for your ads, please provide your YCash Viewing Key (z-view key).",
  ...
  "pl-PL": {
    translation: {
      ...
      "profile": {
        ...
        "paymentDescYec": "Aby włączyć monitorowanie płatności, podaj swój klucz podglądu YCash (z-view key).",
